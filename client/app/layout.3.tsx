...
export default () => {
	const year = new Date().getFullYear();    
     return  <footer className="bg-slate-50 text-slate-600 border-t-2 border-[#115eeb] w-screen bottom-0 left-0 mt-auto" style={{ zIndex: 10 }}>
			<div className="max-w-5xl mx-auto px-4 py-10 flex flex-col md:flex-row md:justify-between gap-8 text-center md:text-left ">
				...
				<nav className="flex flex-col gap-2 md:w-1/3 items-center md:items-start">
					...
					<a href="/termini-condizioni" className="hover:underline">
			...
			<div className="border-t border-brand text-xs text-center py-4 px-2 bg-slate-50">
				...
				<div className="mt-1 text-[11px] text-slate-500 max-w-2xl mx-auto">
					Questo sito partecipa a programmi di affiliazione e riceve una commissione per gli acquisti idonei effettuati tramite i
					link forniti, senza alcun costo aggiuntivo.
				</div>
			</div>
		</footer>
}
